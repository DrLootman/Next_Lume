...
export default function HomePresentation() {
  return (
    <section className="presentation">
      ...
      <p>Je suis Camille, une décoratrice d&apos;intérieur passionnée par l&apos;aménagement et la mise en scène des espaces de vie. J&apos;ai récemment obtenu mon diplôme en décoration d&apos;intérieur et j&apos;ai depuis travaillé avec différents clients pour créer des designs intérieurs sur mesure qui répondent à leurs besoins et reflètent leur personnalité.</p>
    </section>
  );
};